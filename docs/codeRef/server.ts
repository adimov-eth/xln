...
import { decodeTxArg, encodeEntityRoot, EntityBlock, EntityInput, EntityRoot, EntityStorage, executeEntityTx } from './entity.js';
...
// Export for testing
export {
    createInitialEntityRoot, createServerState, getEntityState, loadAllEntries, printState, processInput, processMempoolTick,
    receive, replayLog, runSelfTest, saveMutableState, ServerState, updateState
};
