...
test.describe('Complete Proposal Execution E2E', () => {
  test('ALICE CREATES PROPOSAL [RIGHTWARDS] BOB VOTES [RIGHTWARDS] PROPOSAL EXECUTED + COLLECTIVE MESSAGE', async ({ page }) => {
    console.log('[TAKE] Starting COMPLETE PROPOSAL EXECUTION workflow...');
    ...
    console.log('[CAM] Screenshot: Entity created + auto panels');

    // === STEP 3: ALICE SELECTS ENTITY AND CREATES PROPOSAL ===
    console.log('[WOMAN] STEP 3: Alice selecting entity and creating proposal');
    ...
    console.log('[CAM] Screenshot: Alice selected in first panel');
    ...
    console.log('[MAN] STEP 4: Bob selecting entity and voting YES');
    ...
    console.log('[CAM] Screenshot: Bob selected in second panel');
    ...
    console.log('[CAM] Screenshot: Bob voting YES with comment');
    ...
    console.log('[DONE] STEP 5: Verifying proposal execution and collective message');
    ...
    console.log('[CAM] Screenshot: Proposal APPROVED with 2 YES votes');
    ...
    console.log('[OK] STEP 6: Capturing final success state');
    ...
    console.log('[CAM] Screenshot: FINAL SUCCESS - Complete workflow executed');

    // === STEP 7: VERIFICATION SUMMARY ===
    console.log('[FIND] STEP 7: Final verification of complete workflow');
    ...
    console.log('[STATS] FINAL STATE SUMMARY:');
    ...
    console.log(`[FIND] Looking for proposal: "${fullProposalTitle}"`);
    console.log(`[FIND] Available proposals: ${finalState.proposals.map(p => p.title).join(', ')}`);
    expect(ourProposal).toBeDefined();
    expect(ourProposal?.votes.length).toBeGreaterThan(1); // Both alice and bob voted

    console.log('[DONE] COMPLETE SUCCESS! Full proposal execution workflow verified:');
    console.log('[OK] Alice created proposal');
    console.log('[OK] Bob voted YES');
    console.log('[OK] Proposal executed (2/2 threshold met)');
    console.log('[OK] Collective message generated');
    console.log('[OK] All states properly updated');
